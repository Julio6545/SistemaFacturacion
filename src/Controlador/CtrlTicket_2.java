 ...
 * @author JFAA
 */
public class CtrlTicket_2 implements ActionListener, FocusListener{
    private Venta tic;
    ...
    int ganancia;
    //Constructor
    public CtrlTicket_2(Venta tic,ConTicket cTic,jfTicket jfTic){
        this.tic=tic;
        this.cTic=cTic;
        this.jfTic=jfTic;               
        ...
        if(e.getSource()==jfTic.btnRegistrar){
            if (jfTic.jtDetalle.getRowCount()==0){
                ...
                try{
                    ...
                    //0=yes, 1=no, 2=cancel
                    if(op == 0) {
                        Imprimir(); //System.out.println("Has pulsado Yes");
