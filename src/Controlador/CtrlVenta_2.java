 ...
 * @author JFAA
 */
public class CtrlVenta_2 implements ActionListener, FocusListener{
    private Venta ven;
    private ConsultaV cVen;
    private ConTicket cTic = new ConTicket();
    private jfVenta jfVen;
    ...
    //Constructor
    public CtrlVenta_2(Venta fac,ConsultaV cFac,jfVenta jfFac){
        this.ven=fac;
        this.cVen=cFac;
        this.jfVen=jfFac;               
    ...
    public void focusLost(FocusEvent fL) {
        ...
        if(fL.getComponent()==jfVen.txtCodigo){
            if(jfVen.txtCodigo.getText().length()>0){
                ...
                try{
                    if(conPro.buscar(pro)){
                        jfVen.txtDescripcion.setText(pro.getDescripcion());
