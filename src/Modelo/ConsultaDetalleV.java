 ...
 * @author JFAA
 */
public class ConsultaDetalleV extends Conexion{
    //Metodos de consulta a la base de datos
    public boolean registrarDV(DetalleV det) throws SQLException{
        PreparedStatement ps=null; 
        Connection con= getConexion();
        
        String sql="INSERT INTO detalleventa("
                + "nroventa, idproducto, nrolote, cantidad, precio) VALUES (?,?,?,?,?)";
        try{
